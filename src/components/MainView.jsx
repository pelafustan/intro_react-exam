...
export default function MainView({
  ...
  let filtered = [];
  if (
    filters.ancestry.length
    || filters.house.length
    || filters.specie.length
  ) {
      ...
      renderItem={(item) => (
        <List.Item key={item.id}>
          ...
          >
            ...
            <Typography.Paragraph>
              <Typography.Text strong={true}>House:</Typography.Text>{" "}
              {item.house}
            </Typography.Paragraph>
            <Typography.Paragraph>
              ...
              {(() =>
                item.dateOfBirth
                  ? new Date(item.dateOfBirth.split("-").reverse().join("-"))
                      .toDateString()
                      .replace(/^\S+\s/, "")
                  : "Not informed")()}
            </Typography.Paragraph>
